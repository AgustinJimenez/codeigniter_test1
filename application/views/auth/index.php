			...
			<tbody>
				<?php foreach ($users as $user):?>
					<tr>
						...
						<td><?= ($user->active) ? anchor("auth/deactivate/".$user->id, lang('index_active_link'), 'class="btn btn-success"') : anchor("auth/activate/". $user->id, lang('index_inactive_link'), 'class="btn btn-warning"');?></td>
						<td><?= anchor("admin/users/{$user->id}/edit", '<i class="fa fa-pencil" aria-hidden="true"></i>&nbsp;Edit', 'class="btn btn-primary"') ;?></td>
					</tr>
				<?php endforeach;?>
			</tbody>
			<tfoot>
